...
def run():
    ...
    net = Mininet_wifi(controller=None) ##build=True,link=wmediumd, wmediumd_mode=interference) 
    ...
    c0 = net.addController('c0',  controller=RemoteController, port=5005,ip='192.168.8.106')
    ...
    #net.addLink(ap1,ap2, cls=mesh, ssid='mesh-ssid', channel=5)
    #net.addLink(ap2,ap3, cls=mesh, ssid='mesh-ssid', channel=5)
