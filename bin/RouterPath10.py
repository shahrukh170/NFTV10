...
def run():
    ...
    sta1 = net.addStation('sta1',ip='192.168.1.100',mac='00:00:00:00:00:14', position='10,10,0')
    sta2 = net.addStation('sta2',ip='192.168.1.200',mac='00:00:00:00:00:15', position='20,20,0') ##,defaultRoute='via 192.168.1.3')
    ...
    net.addLink(ap1, ap3,cls=TCLink) ###,loss=1,delay='1000ms',bw=0.001)
    net.addLink(ap3, ap2,cls=TCLink) ###,loss=1,delay='1000ms',bw=0.001)
    ...
    net.addLink(sta2, ap2,cls=TCLink)
    ...
    net.get('ap2').cmd(config_rtr1_intf2)
    ...
    command4 = 'sudo ./NELphase-master/nel sender  192.168.2.100 172.16.1.1' ##127.0.0.1'  ## % (net.get('hh2').IP())
