...
def topology(mobility):
    ...
    defaultIP = '172.16.1.2/8'  # IP address for r0-eth1
    ...
    sta1 = net.addStation( 'sta1', mac='00:00:00:00:00:02', ip='172.16.1.1/8', position='50,50,0',range="50" )
    sta2 = net.addStation( 'sta2', mac='00:00:00:00:00:03', ip='172.16.1.4/8', position='40,50,0',range="50")
    #sta3 = net.addStation( 'sta3', mac='00:00:00:00:00:04', ip='10.0.0.4/8', position='20,50,0')

    ap1 = net.addAccessPoint( 'ap1', ssid= 'new-ssid', mode= 'g', channel= '5', position='25,50,0', range='105',cls=OVSKernelAP, failmode='standalone', stp=True)
    ap2 = net.addAccessPoint( 'ap2', ssid= 'new-ssid', mode= 'g', channel= '5', position='75,50,0', range='105',cls=OVSKernelAP, failmode='standalone', stp=True)
    ...
    ## Note : if you use cls=TCLink then its a wired connection
    net.addLink(ap1, sta1,cls=TCLink,loss=50.0,delay='0ms',bw=0.10)
    net.addLink(ap2, sta2,cls=TCLink,loss=50.0,delay='0ms',bw=0.10)
    ...
    info(net['r0'].cmd("ip route add 192.168.0.0/8 via 192.168.1.2 dev r0-eth0"))
